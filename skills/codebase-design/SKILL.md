...
description: Shared vocabulary and workflow for designing deep modules — use when designing or improving a module, API, or function interface, placing a seam, or making code more testable. Also for finding deepening opportunities or when another skill needs the deep-module vocabulary. Includes glossary, interface-first workflow, R patterns, and a practical checklist.
---
