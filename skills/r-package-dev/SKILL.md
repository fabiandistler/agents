---
name: r-package-dev
description: Design and develop R packages the tidyverse way — package-private state and persistence, load/attach behavior, lifecycle staging and deprecation, and interface-focused testing with reliable fixtures. Use when building or refactoring an R package, including the single-function development workflow from interface design to docs.
