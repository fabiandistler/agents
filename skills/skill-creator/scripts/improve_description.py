...
by calling the configured coder CLI ($CODER_CLI, default: claude) as a
subprocess. When using the default claude backend, this reuses the
session's Claude Code auth — no separate ANTHROPIC_API_KEY needed.
"""
